...
class ViewController: UIViewController {
    ...
    var selectedImage: MemoCard = MemoCard(keyNumber: "00", keyWord: "НоМерок", keyLetters: "НМ", fileName: "00 НМ НоМерок")
    ...
    func selectImage() -> String {
        ...
        selectedImage = memoCards.randomElement() ?? MemoCard(keyNumber: "00", keyWord: "НоМерок", keyLetters: "НМ", fileName: "00 НМ НоМерок")
